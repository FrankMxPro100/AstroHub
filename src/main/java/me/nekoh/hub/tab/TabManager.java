package me.nekoh.hub.tab;

import me.nekoh.hub.util.reflection.TinyProtocol;
...
public class TabManager {
    ...
    private static HashMap<UUID, TabManager> players = new HashMap<>();
    ...
    private TabManager(Player player) {
        this.player = player;
        ...
        this.setupTab();
        TabManager.players.put(player.getUniqueId(), this);
    }
    ...
    public static TabManager createTabList(Player player) {
        return new TabManager(player);
    }

    public static TabManager deleteTabList(Player player) {
        return players.remove(player.getUniqueId());
    }

    public static TabManager getByPlayer(Player player) {
    ...
    private static class Protocol {
        ...
        private static void enablePacketListener() {
            new TinyProtocol(TabManager.plugin) {
    ...
    private static class Reflex {
        ...
        static <T> T getValue(Object object, String field, Class<T> clazz) {
